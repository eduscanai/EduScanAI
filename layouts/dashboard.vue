...
const { isAdmin, isPedagogue, isTeacher, isStudent, isCollaborator, canViewAllStudents } = usePermissions()
...
const itensNavegacao = computed<ItemNav[]>(() => [
  ...
  },
  {
    ...
    visivel: isAdmin.value || isPedagogue.value || isCollaborator.value
  },
  {
    label: 'Calendário',
    to: '/calendario',
